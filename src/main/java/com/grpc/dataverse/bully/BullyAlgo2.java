...
public class BullyAlgo2 implements Runnable{
    static int leader_id=-1;
    static int self_id=-1;
    static int server_Port = 5512 ;
    String operation;
    String reqtype;
    ...
    static String FOLDER_PATH = "F:\\275\\server2\\";

    public BullyAlgo2(String operation) {
        this.operation = operation;

    }

    public BullyAlgo2(String operation, String reqtype) {
        this.operation = operation;
    ...
    public static void main(String args[]) throws UnknownHostException, IOException, InterruptedException{
        ...
        Server server = ServerBuilder.forPort(55120)
//				.maxInboundMessageSize(FILE_SPLIT_UNIT)
//				.maxInboundMetadataSize(Integer.MAX_VALUE)
                .addService(new FileService2())
                .addService(new MessageService())
                .build();

        server.start();

        Runnable receiver = new BullyAlgo2("receiver");
        new Thread(receiver).start();

        // Thread.sleep(10);


        Runnable heartbeat = new BullyAlgo2("heartbeat");
        ...
        if(operation.equals("timer")){
            ...
            try{
                ...
                if(!received){
                    ...
                    Runnable sender = new BullyAlgo2("sender","cood");
                ...
                if(received && !leader_flag){
                    ...
                    Runnable sender = new BullyAlgo2("sender","elecreq");
                    new Thread(sender).start();
                ...
                while(true){
                    ...
                    if(option.equals("elecreq")){
                        ...
                        if(self_id>source_id){
                            Runnable sender = new BullyAlgo2("sender","ok");
                            new Thread(sender).start();
                        ...
                        if(!election_req){
                            ...
                            Runnable timer = new BullyAlgo2("timer");
            ...
            while(true){
                try{
                    ...
                    if(leader_flag && (self_id!=leader_id)){
                        ...
                        Socket socket = new Socket(destination_server , processes_port.get(leader_id));
                        DataOutputStream out = new DataOutputStream(socket.getOutputStream());
                        out.writeUTF("heartbeat");
                        out.writeUTF(self_id+"");

                        System.out.println("Sent HEARTBEAT to : "+destination_server+":"+processes_port.get(leader_id));
