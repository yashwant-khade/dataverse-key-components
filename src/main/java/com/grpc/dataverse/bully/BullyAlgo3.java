...
public class BullyAlgo3 implements Runnable{
    static int leader_id=-1;
    static int self_id=-1;
    static int server_Port = 5513 ;
    String operation;
    String reqtype;
    ...
    public BullyAlgo3(String operation, String reqtype) {
        this.operation = operation;
...
//				.maxInboundMetadataSize(Integer.MAX_VALUE)
        ...
        Runnable receiver = new BullyAlgo3("receiver");
        new Thread(receiver).start();

        // Thread.sleep(10);


        Runnable heartbeat = new BullyAlgo3("heartbeat");
        ...
        if(operation.equals("timer")){
            ...
            try{
                ...
                if(!received){
                    ...
                    Runnable sender = new BullyAlgo3("sender","cood");
                ...
                if(received && !leader_flag){
                    ...
                    Runnable sender = new BullyAlgo3("sender","elecreq");
                    new Thread(sender).start();
                ...
                while(true){
                    ...
                    if(option.equals("elecreq")){
                        ...
                        if(self_id>source_id){
                            Runnable sender = new BullyAlgo3("sender","ok");
                            new Thread(sender).start();
                        ...
                        if(!election_req){
                            ...
                            Runnable timer = new BullyAlgo3("timer");
