package com.grpc.dataverse.bullyalgo;
...
public class BullyAlgo5 implements Runnable{
    static int leader_id=-1;
    static int self_id=-1;
    static int server_Port = 5515 ;
    String operation;
    String reqtype;
    ...
    public BullyAlgo5(String operation) {
        this.operation = operation;

    }

    public BullyAlgo5(String operation, String reqtype) {
        this.operation = operation;
    ...
    public static void main(String args[]) throws UnknownHostException, IOException, InterruptedException{
        initialize();
        Runnable receiver = new BullyAlgo5("receiver");
        new Thread(receiver).start();

        // Thread.sleep(10);


        Runnable heartbeat = new BullyAlgo5("heartbeat");
        ...
        if(operation.equals("timer")){
            ...
            try{
                ...
                if(!received){
                    ...
                    Runnable sender = new BullyAlgo5("sender","cood");
                ...
                if(received && !leader_flag){
                    ...
                    Runnable sender = new BullyAlgo5("sender","elecreq");
                    new Thread(sender).start();
                ...
                while(true){
                    ...
                    if(option.equals("elecreq")){
                        ...
                        if(self_id>source_id){
                            Runnable sender = new BullyAlgo5("sender","ok");
                            new Thread(sender).start();
                        ...
                        if(!election_req){
                            ...
                            Runnable timer = new BullyAlgo5("timer");
